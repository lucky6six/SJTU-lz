...
\begin{table}[!hpt]
    ...
    \begin{tabular}{@{} >{\raggedright\arraybackslash}p{0.15\linewidth}
        ...
        \toprule
        对照组 & 方案说明 \\ \midrule
        BASE & 基础对照组，在开源系统 Destor 的基础集成 ZSTD 压缩算法，代表目前工业界主流的变长块级去重加通用压缩的传统方案。 \\\midrule
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{模型数据分离模块}：实验证明，本文提出的基于字节熵的类型鉴别方法，在保持极高准确率的同时，显著提升了处理效率，在性能和精度之间取得了理想的平衡。
