...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    zh / title           = {细粒度冗余识别的数据缩减系统研究},
    en / title           = {Research on Data Reduction System with Fine-Grained Redundancy Identification},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    zh / keywords        = {存储, 数据缩减, 去重, 压缩, 细粒度, 大语言模型, 混合负载},
    en / keywords        = {storage, data reduction, deduplication, compression, fine-grained, large language model, mixed workload},
    %
    % 姓名
    %
    % zh / author          = {刘\quad{}茁},
    ...
    %
    zh / degree          = {专业型硕士},
    en / degree          = {Professional Master's Degree},
    %
    % 答辩日期
